...
<head>
    ...
    <style>
        ...
        /* Media Queries untuk tablet & HP kecil */
    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="card card-login">
            ...
            <div class="btn-group-custom mt-3">
                <a href="employee_register.php" class="btn btn-register"><i class="fas fa-user-plus"></i> Register</a>
                <a href="login_admin.php" class="btn btn-admin"><i class="fas fa-shield-alt"></i> Admin</a>
            </div>
        </div>
    </div>
